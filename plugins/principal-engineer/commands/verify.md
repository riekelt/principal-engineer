...
3. Check the report before relaying: gates output with no surface driven is incomplete. Re-dispatch the same agent once with the gap named; a second gates-only report goes to the user as UNVERIFIABLE with that reason.
